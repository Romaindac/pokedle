// Charge UNE fois la table nom -> numero des 1025 Pokemon (Gen 1-9).
let tableNoms = null

export async function chargerTableNoms() {
  if (tableNoms) return tableNoms
  try {
...
// Renvoie le numero d'un Pokemon par son nom (ou null si inconnu).
...
// ============================================================
// Table numero -> nom anglais (pour les sprites animes Showdown).
// ============================================================

export const NOMS_POKEDEX = {
  1: "bulbasaur",
  2: "ivysaur",
  3: "venusaur",
  4: "charmander",
...
// Nom "Showdown" d'un Pokémon par numéro (nettoyé : minuscules, sans caractères spéciaux).
// Ex: 122 mr-mime -> mrmime, 250 ho-oh -> hooh, 29 nidoran-f -> nidoranf.
export function nomShowdown(numero) {
  const nom = NOMS_POKEDEX[numero]
  if (!nom) return null
